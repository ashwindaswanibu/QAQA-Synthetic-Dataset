...
for idx, question in enumerate(data['Old Question']):
    ...
    false_assumption_question = question + ''' Is every statement or assumption in this previous question accurate? Please answer with a simple 'Yes' or 'No'.''' + '\n' + "Answer: "
    ...
    if idx % 10 == 0:
        data.to_csv('hotpot_incontext_without_rationale_target_no_old.csv', index=False)
