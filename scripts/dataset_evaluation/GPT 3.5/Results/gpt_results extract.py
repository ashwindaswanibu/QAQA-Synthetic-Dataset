...
import re
# Read the latest CSV file into a DataFrame again
df_latest = pd.read_csv('Hotpot_gpt_eval_without_incontext_yes.csv')
...
import re
# Read the latest CSV file into a DataFrame again
df_latest = pd.read_csv('Hotpot_questions_after_eval_gpt_incontext_target_no.csv')
...
import re
# Read the latest CSV file into a DataFrame again
df_latest = pd.read_csv('Hotpot_questions_after_eval_gpt_incontext_target_no_without_rationale.csv')
...
import re
# Read the latest CSV file into a DataFrame again
df_latest = pd.read_csv('Hotpot_questions_after_eval_gpt_incontext_yes.csv')
...
import re
# Read the latest CSV file into a DataFrame again
df_latest = pd.read_csv('Hotpot_questions_after_eval_gpt_incontext_yes_without_rationale.csv')
...
value_counts = data['Yes/No'].value_counts()
print(value_counts)
...
# The correct column name is 'False-Assumption'
false_assumption_column = 'Yes/No'
