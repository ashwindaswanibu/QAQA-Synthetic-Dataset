...
def process_data(data, model, tokenizer, model_name):
    ...
    for idx in range(start_index, len(data)):
        ...
        data.to_csv(
            'singlehop_incontext_responses_flan_target_no_without_rationale-old.csv', index=False)
...
try:
    data = pd.read_csv('singlehop_incontext_responses_flan_target_no_without_rationale_old.csv')
