...
def process_data(input_csv, output_csv):
    try:
        ...
        start_index = data['LLaMA-Yes/No'].isnull().idxmax()
    ...
    for idx in range(start_index, len(data)):
        ...
        yes_no_question = data['unperturbed_yes_no_question'].iloc[idx]
...
input_csv = '../../Datasets/singlehop_unperturbed.csv'
output_csv = 'singlehop_incontext_unperturbed_yes_no.csv'
...
# Setup model configuration and tokenizer
model_id = 'meta-llama/Llama-2-70b-chat-hf'
hf_auth = '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'
...
input_csv = '../../Datasets/Singlehop_complex_questions.csv'
output_csv = 'singlehop_incontext_target_yes_without_rationale_old.csv'
process_data(input_csv, output_csv)
